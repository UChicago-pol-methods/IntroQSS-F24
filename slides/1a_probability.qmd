...
- rolling an even number [(three outcomes outcome)]{.gray}
- in an election, a tie for first between candidates $a$ and $b$ [(many different outcomes)]{.gray}
...
In subjective terms, if $A$ and $B$ are independent, then knowing $B$ occurred does not affect our assessment of probability that $A$ occurred. 
