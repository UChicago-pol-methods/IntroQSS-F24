...
- Teaching assistant: John Kainer
- part of a sequence:
...
- 20% in-class midterm, session 4.2 (October 23) 
- 30% final take-home exam due December 10
...
1. Download files one by one, or 
1. `git clone` and periodically update via `git pull`. 
...
1. New file -> Quarto document; then `Render` to make pdf.
...
<!-- If you can "knit" the first homework (`ps1_2024_probability.qmd`) into a PDF, you are all set. -->
...
Our goal in this class is to understand topics every social scientist needs to know:
