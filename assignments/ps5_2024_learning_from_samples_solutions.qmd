...
subtitle: "Due November 4, 2024, at 10am"
format: pdf
---
...
\begin{align}
\V\left[\overline{X}\right] &= \V\left[\frac{1}{n}\left(X_1 + X_2 + \ldots + X_n \right) \right]  \tag{Step 1} \\
...
By running this code, you will load two variables (`aa_2012` and `env_2012`) into `R`'s memory and set a seed so that we get the same results from simulations:
