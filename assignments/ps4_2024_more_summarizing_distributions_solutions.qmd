...
subtitle: "Due October 28, 2024, at 10am"
format: pdf
---
...
**Answer**: By Theorem 2.2.21 of Aronow and Miller, $\beta = \frac{\text{Cov}[X, Y]}{\V[X]}$ and $\alpha = \E[Y] - \beta  \E[X]$. Using calculations above, $\beta = \frac{1/6}{1/4} = 2/3$ and $\alpha = \frac{1}{3} - \frac{2}{3}\frac{1}{2} = 0$.
